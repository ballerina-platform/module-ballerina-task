...
public class Utils {
    ...
    public static JobDetail createJob(ServiceInformation serviceInformation, String jobId) {
        JobDataMap jobDataMap = new JobDataMap();
        jobDataMap.put(TaskConstants.JOB, serviceInformation);
        return JobBuilder.newJob(TaskJob.class).withIdentity(serviceInformation.getServiceName(),
                jobId).usingJobData(jobDataMap).build();
    }
